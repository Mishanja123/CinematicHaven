import { SvgBox, Svg } from './ListTrueSvg.styled';


export const ListTrueSvg = () => {
    return (
      <SvgBox>
<Svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 20 20">
<title>list-true</title>
